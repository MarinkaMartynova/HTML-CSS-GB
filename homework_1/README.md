## Введение и Основы HTML (домашняя работа)
...
7. Добавить параграф p с произвольным текстом (lorem) (используем расширение emmet же установленное в vsc, для этого вводим lorem и нажимаем клавишу tab).
...
18. Добавить в папку img произвольные фотографии товаров, по вашей тематике можно ыбрать любое фото https://www.freepik.com/search?format=search&rientation=portrait&query=products
